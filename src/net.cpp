...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Tenfivecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    /* North America */
    { "na.seed.tenfivecoin.com", "na.seed.tenfivecoin.com" },

    /* South America */
    { "sa.seed.tenfivecoin.com", "sa.seed.tenfivecoin.com" },
   
    /* Europe */
    { "eu.seed.tenfivecoin.com", "eu.seed.tenfivecoin.com" },
 
    /* Asia */
    { "asia.seed.tenfivecoin.com", "asia.seed.tenfivecoin.com" },

    /* Africa */
    { "africa.seed.tenfivecoin.com", "africa.seed.tenfivecoin.com" },
...
static const char *strTestNetDNSSeed[][2] = {
    { "testnetwork.seed.tenfivecoin.com", "testnetwork.seed.tenfivecoin.com" },
    { NULL, NULL }
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Tenfivecoin is probably already running."), addrBind.ToString().c_str());
        else
